...
#define BM_FPGA_CMD_LEN  4
#define	BM_FPGA_CRC_BITS		5
#define	BM_FPGA_CMD_BITS_WITHOUT_CRC	(BM_FPGA_CMD_LEN*8-BM_FPGA_CRC_BITS)
#define BM_FPGA_RESP_LEN 5
...
//#define BITMAIN_DEFAULT_BAUD            1500000

// default ticket mask

#define DEVICE_DIFF_SET                 0x4
#define DEVICE_DIFF_SET_MASK            0x0fffffff
...
#else
/******************** about A8 platform ********************/
#define FAN0                    "148:"   // front fan
#define FAN1                    "164:"   // back fan
...
#define ASIC_RETURN_DATA_LENGTH                     0x5
...
//TMP750 register
#define TMP750_IIC_TEMP_REG  0x0
#define TMP750_IIC_CONFIG_REG 0x01
#define TMP750_IIC_TLOW_REG 0x02
#define TMP750_IIC_THIGH_REG 0x03
...
struct all_parameters
{
    ...
    int16_t     chain_asic_temp[BITMAIN_MAX_CHAIN_NUM][8];
...
struct work_btc_fpga
{
    uint8_t wc;                           // Bit[7:5]: Type,fixed as 0x01. Bit[4]:sno valid   Bit[3:0]:reserved
    uint32_t tm;                             // bit[7]: reserved, bit[6:0]: work count base
    uint32_t hcn;
    uint8_t work[80];   // 0-75 bytes are sia work; 76-79 are start nonce field
};
